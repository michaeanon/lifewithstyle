            ...
            <div className="grid lg:grid-cols-2 gap-12 items-center">
              <motion.div initial={{ opacity: 0, y: 20 }} animate={{ opacity: 1, y: 0 }} transition={{ duration: 0.5 }}>
                ...
                <p className="text-lg mb-6">
                  Life With Style was founded with a simple mission: to help everyone discover their personal style and
                  build a wardrobe that truly reflects who they are.
                </p>
                <p className="text-lg mb-8">
                  What began as a personal styling blog has evolved into a comprehensive resource for fashion
                  enthusiasts seeking guidance, inspiration, and practical advice on developing their unique aesthetic.
                </p>
                <Link href="/contact">
          ...
          <div className="container px-4 sm:px-6 lg:px-8 max-w-7xl mx-auto">
            <div className="text-center mb-16">
              ...
              <p className="text-lg text-muted-foreground max-w-3xl mx-auto">
                We believe that style is a form of self-expression that should be accessible to everyone, regardless of
                budget, body type, or fashion experience.
              </p>
            </div>
            ...
            <div className="grid md:grid-cols-3 gap-8">
              ...
              >
                <div className="bg-ilary-peachLight w-16 h-16 rounded-full flex items-center justify-center mx-auto mb-6">
                  <span className="text-2xl font-serif">1</span>
                </div>
                <h3 className="text-xl font-medium mb-4">Personal Expression</h3>
                <p className="text-muted-foreground">
                  We view fashion as an extension of your identity, not a set of rigid rules to follow. Our approach
                  focuses on helping you discover what resonates with your personality and lifestyle.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-medium mb-4">Thoughtful Consumption</h3>
                <p className="text-muted-foreground">
                  We advocate for building a curated wardrobe of versatile, quality pieces rather than chasing fleeting
                  trends. This approach is both sustainable and economical in the long run.
                </p>
              </motion.div>
              ...
              >
                ...
                <h3 className="text-xl font-medium mb-4">Inclusive Guidance</h3>
                <p className="text-muted-foreground">
                  We provide advice that can be adapted to diverse body types, budgets, and style preferences. Our goal
                  is to empower, not dictate, your fashion choices.
                </p>
              </motion.div>
            </div>
          </div>
...
const journeyMilestones = [
  ...
  },
  {
    ...
    imageSrc: "https://images.unsplash.com/photo-1490481651871-ab68de25d43d?q=80&w=2070&auto=format&fit=crop",
  },
]
